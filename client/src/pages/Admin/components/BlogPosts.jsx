...
//   // Add these handler functions inside your BlogPosts component
...
//                 <div className={`w-20 h-20 rounded-2xl ${post.thumbnail} flex-shrink-0 flex items-center justify-center text-white text-2xl`}>📝</div>
...
//                     {/* Action Buttons - Added Edit and View buttons */}
...
//             <p className="text-gray-600 mb-6">{activeTab === "draft" ? "You don't have any draft posts yet." : "You don't have any published posts yet."}</p>
