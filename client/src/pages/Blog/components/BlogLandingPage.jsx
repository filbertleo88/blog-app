...
//   useEffect(() => {
//     fetchPosts(1); // Load first page on component mount
//   }, []);

//   const fetchPosts = async (page = 1) => {
//     try {
//       setLoading(true);
//       const response = await fetch(`http://localhost:5009/api/blogposts/paginated/${page}/4`);
...
//             <button onClick={() => fetchPosts(1)} className="mt-4 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition">
//               Try Again
//             </button>
//           </div>
//         </div>
...
//                   disabled={loading}
//                   className="bg-gradient-to-r from-sky-500 to-cyan-400 text-white px-8 py-3 rounded-lg hover:opacity-90 transition-all duration-200 font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
//                 >
//                   {loading ? (
//                     <>
...
//                 <p className="text-gray-500 text-lg">🎉 You've seen all {totalPosts} posts!</p>
//               </div>
//             )}
//           </>
//         ) : (
