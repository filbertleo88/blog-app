...
// const ModernCommentSection = ({ onCommentAction, isAuthenticated }) => {
...
//     // You can use your existing AuthModal or redirect to login page
...
//             Please{" "}
//             <button onClick={redirectToAuth} className="text-blue-600 hover:text-blue-800 underline font-medium">
//               login
//             </button>{" "}
...
//       <div className="space-y-6">
//         {comments.length > 0 ? (
//           comments.map((comment) => <Comment key={comment._id} comment={comment} onAddReply={handleAddReply} isAuthenticated={isAuthenticated} onAuthRequired={redirectToAuth} />)
//         ) : (
